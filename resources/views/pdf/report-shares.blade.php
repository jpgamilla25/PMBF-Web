...
<head>
    ...
    <style>
        ...
        .header h1 { color: #d97706; font-size: 16px; margin: 0 0 3px; }
        ...
        .summary-cell .val { font-size: 14px; font-weight: bold; color: #d97706; }
        .summary-cell .lbl { font-size: 8px; color: #6b7280; text-transform: uppercase; }
        table { width: 100%; border-collapse: collapse; }
        th { background: #d97706; color: #fff; padding: 4px 5px; text-align: right; font-size: 8px; }
        ...
        .total-row td { font-weight: bold; background: #fff7ed; border-top: 2px solid #d97706; }
    </style>
</head>
<body>
    <div class="header">
        <h1>PMBF &mdash; Share Capital Report {{ $year }}</h1>
    ...
    <div class="summary-grid">
        ...
        <div class="summary-cell">
            ...
            <div class="lbl">Total Share Capital {{ $year }}</div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $row['user']->employment_type }}</td>
                @for($m = 1; $m <= 12; $m++)
